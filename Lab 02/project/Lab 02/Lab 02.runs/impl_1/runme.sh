...
HD_PWD='C:/Users/klinez/ECE212_Kline_Wurm/Lab 02/project/Lab 02/Lab 02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dig_clock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dig_clock_top.tcl -notrace
