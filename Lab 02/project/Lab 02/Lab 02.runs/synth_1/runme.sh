...
HD_PWD='C:/Users/klinez/ECE212_Kline_Wurm/Lab 02/project/Lab 02/Lab 02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dig_clock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dig_clock_top.tcl
